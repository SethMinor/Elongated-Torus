...
alpha1_ecc = [0, 0.2917, 0.3997, 0.533];
alpha1_MLE = [0.0082413, 0.085404, 0.1211, 0.16284];

% Alpha = 3/11 = 0.1818 exponents
alpha2_ecc = [0, 0.3997, 0.533, 0.6515, 0.7045, 0.7262, 0.745];
alpha2_MLE = [0.0074608, 0.0052082, 0.0084947, 0.0091884, 0.01342, 0.013196, 0.09563];
